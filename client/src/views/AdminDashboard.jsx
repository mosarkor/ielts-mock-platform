                      ...
                      <div style={{ backgroundColor: 'var(--bg-tertiary)', borderRadius: '10px', padding: '1.25rem', border: '1px solid var(--glass-border)' }}>
                        ...
                        {speakingPrompts.length > 0 && (
                          <form onSubmit={handleAssignSpeaking}>
                            ...
                            <div className="form-group">
                              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.4rem' }}>
                                <label className="form-label" style={{ margin: 0 }}>Select Candidates</label>
                                <span style={{ fontSize: '0.75rem', color: 'var(--text-secondary)' }}>
                                  Selected: {speakingAssignStudents.length} / {students.length}
                                </span>
                              </div>
                              ...
                              <div style={{ display: 'flex', gap: '0.35rem', marginBottom: '0.5rem', flexWrap: 'wrap' }}>
                                <button
                                  ...
                                  className="btn btn-secondary"
                                  style={{ padding: '0.2rem 0.55rem', fontSize: '0.75rem', backgroundColor: '#6366f1', color: '#fff', borderColor: '#6366f1' }}
                                  onClick={() => setSpeakingAssignStudents(students.map(s => s.id))}
                                >
                                  Select ALL ({students.length})
                                </button>
                                <button
                                  ...
                                  className="btn btn-secondary"
                                  style={{ padding: '0.2rem 0.55rem', fontSize: '0.75rem' }}
                                  onClick={() => setSpeakingAssignStudents(students.filter(s => s.id.startsWith('G1')).map(s => s.id))}
                                >
                                  Group 1
                                </button>
                                <button
                                  ...
                                  className="btn btn-secondary"
                                  style={{ padding: '0.2rem 0.55rem', fontSize: '0.75rem' }}
                                  onClick={() => setSpeakingAssignStudents(students.filter(s => s.id.startsWith('G2')).map(s => s.id))}
                                >
                                  Group 2
                                </button>
                                <button
                                  ...
                                  className="btn btn-secondary"
                                  style={{ padding: '0.2rem 0.55rem', fontSize: '0.75rem' }}
                                  onClick={() => setSpeakingAssignStudents(students.filter(s => s.id.startsWith('G3')).map(s => s.id))}
                                >
                                  Group 3
                                </button>
                                <button
                                  ...
                                  className="btn btn-secondary"
                                  style={{ padding: '0.2rem 0.55rem', fontSize: '0.75rem' }}
                                  onClick={() => setSpeakingAssignStudents(students.filter(s => s.id.startsWith('G4')).map(s => s.id))}
                                >
                                  Group 4
                                </button>
                                <button
                                  ...
                                  className="btn btn-secondary"
                                  style={{ padding: '0.2rem 0.55rem', fontSize: '0.75rem', backgroundColor: '#f43f5e', color: '#fff', borderColor: '#f43f5e' }}
                                  onClick={() => setSpeakingAssignStudents([])}
                                >
                                  Clear
                                </button>
                              </div>
